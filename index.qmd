...
* Showing sample mean and SD or standard error are NOT recommended as bar plots with error bars!
...
* The bar often also hides the sample size. A bar showing the mean value for n=3 may look identical to a bar showing the mean value for n=300. The audience can't gauge this from the bar alone and can be misleading.
